...
export default function RegisterPage() {
  ...
  const passwordRequirements = [
    ...
    { label: "包含数字", met: /[0-9]/.test(formData.password) },
    {
      label: "确认密码匹配",
      met:
  ...
  return (
    <div className="min-h-screen bg-background flex">
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              ...
              className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-base group disabled:opacity-50"
            >
              {isLoading ? (
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        {/* 装饰线条 */}
        <div className="absolute top-20 right-10 w-32 h-1 bg-primary" />
        <div className="absolute top-20 right-10 w-1 h-32 bg-primary" />
        <div className="absolute bottom-20 left-10 w-32 h-1 bg-primary" />
        <div className="absolute bottom-20 left-10 w-1 h-32 bg-primary" />
